...
// Se incluyen los archivos de cada tipo de planta e información
...
int main() {
    ...
    // Se crean plantas carnívoras con sus datos de información
    ...
    // Se crean los cuidados correspondientes
    ...
    // Opción si se elige planta carnívora:
    if (tipoPlanta == 1) {
        ...
        // Se le pregunta al usuario que desea hacer siguiente
            ...
            // Se muestra la información, precios, o cuidados correspondientes
    ...
    // Opción si se elige planta cactus:
    ...
    // Opción si se elige planta flor:
